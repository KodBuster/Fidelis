...
const PILLARS = [
  {
    title: "Сияние на каждый день",
    text: "Сдержанный блеск серебра 925 — для повседневного образа",
  },
  {
  ...
  },
  {
    ...
    text: "Контролируем каждый этап — от чистоты сплава до финишной обработки, чтобы вы получали безупречные украшения",
  },
  {
    title: "Вау-цена",
  ...
  {
    title: "Со вставками и без",
    text: "Чистые серебряные формы и модели со вставками — выбирайте то, что вам ближе",
  },
  {
    title: "От спортзала до красной дорожки",
    text: "Забудьте про дресс-код. Наши украшения созданы для жизни, а не для сейфа. Носите с любимым спортивным костюмом или вечерним шелком.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            <div className="space-y-5 text-brand-text leading-relaxed">
              ...
              <p>
                ...
                из серебра 925. Бренд делает красоту понятной и доступной,
                стирая границы между торжественным выходом и повседневным
                стилем. Серебряные украшения — со вставками и без —
                универсальный выбор под любой образ.
              </p>
              <p>
                ФИДЕЛИС создан для тех, кто выбирает современные украшения и
                ценит честную подачу: металл, форма и характеристики изделия —
                без лишних обещаний.
              </p>
              <p>
            ...
            <div className="relative aspect-square max-w-md mx-auto lg:max-w-none lg:ml-auto w-full">
              ...
              <Image
                ...
                alt="Браслет ФИДЕЛИС из серебра 925"
                fill
