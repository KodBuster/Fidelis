...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    ...
    title: "Украшения из серебра ФИДЕЛИС",
    description:
      "Только серебро 925: модели со вставками и без, характеристики и гарантия.",
  ...
  },
  {
    ...
    description:
      "Почему серебро стало самостоятельным эстетическим выбором, как его носить в многослойности и сочетать из серебра 925.",
    datePublished: "2026-09-04",
    dateModified: "2026-09-04",
  },
];
